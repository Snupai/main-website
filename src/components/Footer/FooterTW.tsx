...
export default function FooterTW() {
  return (
    <footer className="relative mt-28 border-t border-white/10 bg-black/60 backdrop-blur-2xl">
      <div className="container mx-auto max-w-6xl px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 mb-12">
          {/* Brand */}
          <div className="lg:col-span-2 space-y-6">
            <h3 className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary-300)] to-[var(--accent-300)] text-2xl font-bold">Astrakit</h3>
            <p className="text-[var(--text-200)] max-w-md leading-7">
              Free and open-source chat app designed by nerds. Enjoy secure, seamless communication with powerful features.
            </p>
            <div className="flex gap-3">
              <a href="#" aria-label="GitHub" className="w-11 h-11 rounded-xl border border-white/10 bg-white/5 text-[var(--text-300)] flex items-center justify-center hover:border-[var(--primary-400)] hover:text-[var(--primary-300)] hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(127,0,255,0.2)] transition">
              ...
              <a href="#" aria-label="Discord" className="w-11 h-11 rounded-xl border border-white/10 bg-white/5 text-[var(--text-300)] flex items-center justify-center hover:border-[var(--primary-400)] hover:text-[var(--primary-300)] hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(127,0,255,0.2)] transition">
              ...
              <a href="#" aria-label="Twitter" className="w-11 h-11 rounded-xl border border-white/10 bg-white/5 text-[var(--text-300)] flex items-center justify-center hover:border-[var(--primary-400)] hover:text-[var(--primary-300)] hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(127,0,255,0.2)] transition">
          ...
          <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            <div>
              ...
              <ul className="space-y-2">
                <li><a className="text-[var(--text-300)] hover:text-[var(--primary-300)] transition" href="#download">Download</a></li>
